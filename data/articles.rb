...
article {
  key 'ahmad:2022:tse'
  title '{TRIMMER}: {A}n Automated System for Configuration-based Software Debloating'
...
article {
  key 'jiang:2022:tr'
  title '{SMARTEST}: {A} Surrogate-Assisted Memetic Algorithm for Code Size Reduction'
  author 'He Jiang',
         'Guojun Gao',
         'Zhilei Ren',
         'Xin Chen',
         'Zhide Zhou'
  fragment 'journal/ieee-tr'
  volume 71
  number 1
  pages '190--203'
  doi '10.1109/TR.2021.3073960'
}

article {
  key 'mamaghan:2022:ejor'
  ...
  author 'Maryam Karimi Mamaghan',
         'Mehrdad Mohammadi',
         'Patrick Meyer',
         'Amir Mohammad Karimi{-}Mamaghan',
         'El{-}Ghazali Talbi'
  fragment 'journal/ejor'
  volume 296
  number 2
  pages '393--422'
...
article {
  key 'chen:2021:tse'
  title '{SequenceR}: {S}equence-to-Sequence Learning for End-to-End Program Repair'
  author 'Zimin Chen',
         'Steve Kommrusch',
         'Michele Tufano',
         'Louis{-}Noël Pouchet',
...
article {
  key 'soto-valero:2021:ese'
  title 'A comprehensive study of bloated dependencies in the {M}aven ecosystem'
  author 'César Soto{-}Valero',
         'Nicolas Harrand',
         'Martin Monperrus',
         'Benoit Baudry'
  fragment 'journal/ese'
  volume 26
  number 3
  pages 45
...
article {
  key 'trujillo:2021:softw'
  title 'A Novel Approach For Search-Based Program Repair'
...
article {
  key 'devore-mcdonald:2020:oopsla'
  title 'Mossad: {D}efeating software plagiarism detection'
  author 'Breanna Devore{-}McDonald',
         'Emery D. Berger'
  fragment 'journal/acm-pl'
  volume 4
  number '{OOPSLA}'
  pages '138:1--138:28'
  doi '10.1145/3428206'
...
article {
  key 'yuan:2020:tse'
  title '{ARJA}: {A}utomated Repair of {J}ava Programs via Multi-Objective Genetic Programming'
  author 'Yuan Yuan',
         'Wolfgang Banzhaf'
  fragment 'journal/ieee-tse'
  volume 46
...
article {
  key 'yuan:2020:tsem'
  title 'Toward Better Evolutionary Program Repair: {A}n Integrated Approach'
  author 'Yuan Yuan',
         'Wolfgang Banzhaf'
  fragment 'journal/acm-tsem'
  volume 29
...
article {
  key 'harrand:2019:gpem'
  title 'A journey among {J}ava neutral program variants'
...
article {
  ...
  number 22
  pages '11593--11609'
  doi '10.1007/s00500-018-03705-6'
}
...
article {
  key 'wang:2019:access-1'
  title 'A Spectral Clustering-Based Multi-Source Mating Selection Strategy in Evolutionary Multi-Objective Optimization'
  author 'Shuai Wang',
         'Hu Zhang',
         'Yi Zhang',
         'Aimin Zhou',
  ...
  volume 7
  pages '131851--131864'
  doi '10.1109/ACCESS.2019.2941123'
}
...
article {
  key 'zou:2018:tpds'
  title 'A Code Generator for Energy-Efficient Wavefront Parallelization of Uniform Dependence Computations'
  author 'Yun Zou',
         'Sanjay V. Rajopadhye'
  fragment 'journal/ieee-tpds'
  volume 29
...
article {
  key 'langdon:2017:bdm'
  title 'Genetically improved BarraCUDA'
  author 'William B. Langdon',
         'Brian Yee Hong Lam'
  fragment 'journal/bdm'
  volume 10
  number 1
  pages '28:1--28:11'
...
article {
  key 'martinez:2017:ese'
  title 'Automatic repair of real bugs in {J}ava: {A} large-scale experiment on the {Defects4J} dataset'
...
article {
  key 'ramirez:2017:overload'
  title 'Evolutionary Computing Frameworks for Optimisation'
  author 'Aurora Ramírez',
         'Chris Simons'
  fragment 'journal/overload'
  volume 25
  number 142
  pages '14--19'
}
...
article {
  key 'xuan:2017:tse'
  title 'Nopol: {A}utomatic Repair of Conditional Statement Bugs in {J}ava Programs'
  author 'Jifeng Xuan',
         'Matias Martinez',
         'Favio Demarco',
         'Maxime Clement',
...
article {
  key 'ashouri:2016:taco'
  title '{COBAYN}: {C}ompiler Autotuning Framework Using Bayesian Networks'
  author 'Amir H. Ashouri',
         'Giovanni Mariani',
         'Gianluca Palermo',
         'Eunjung Park',
...
article {
  key 'chen:2016:jpdc'
  title '{enDebug}: {A} hardware-software framework for automated energy debugging'
  author 'Jie Chen',
         'Guru Venkataramani'
  fragment 'journal/jpdc'
  volume 96
...
article {
  key 'ma:2016:jcst'
  title 'Highly Optimized Code Generation for Stencil Codes with Computation Reuse for {GPU}s'
  author 'Wenjing Ma',
         'Kan Gao',
         'Guoping Long'
  fragment 'journal/jcst'
  volume 31
  number 6
  pages '1262--1274'
...
article {
  ...
  author 'Qingchuan Shi',
         'Henry Hoffmann',
         'Omer Khan'
  fragment 'journal/ieee-cal'
  volume 14
  number 2
  pages '85--89'
...
article {
  key 'sitthi-amorn:2011:acm-tg'
  title 'Genetic Programming for Shader Simplification'
  author 'Pitchaya Sitthi{-}Amorn',
         'Nicholas Modly',
         'Westley Weimer',
         'Jason Lawrence'
  fragment 'journal/acm-tg'
  volume 30
  number 6
  pages 152
...
article {
  key 'leberre:2010:jsat'
  title 'The {S}at4j library, release 2.2'
  author 'Daniel {Le Berre}',
         'Anne Parrain'
  fragment 'journal/jsat'
  volume 7
  number '2-3'
  pages '59--6'
}
...
article {
  key 'charette:2009:spectrum'
  title 'This car runs on code'
  author 'Robert N. Charette'
  fragment 'journal/ieee-spectrum'
  volume 46
  number 3
}
...
article {
  key 'psarris:2004:tpds'
  title 'An Experimental Evaluation of Data Dependence Analysis Techniques'
...
article {
  ...
  author 'Yin Chan',
         'Ashok Sudarsanam',
         'Andrew Wolfe'
  fragment 'journal/acm-sigarch-can'
  volume 22
  number 4
  pages '60--70'
